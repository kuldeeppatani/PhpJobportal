									...
									<li>
										<a href="job.php">
											...
											<div class="ca-content">
												<h4 class="ca-main"></h4>
												<h3 class="ca-sub">Add Vacancy</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="jobdatashow.php">
										  <i class="fa fa-user" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one"></h4>
												<h3 class="ca-sub one">View Vacancy List</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="registerdata.php">
											...
											<h4 class="ca-main two"></h4>
												<h3 class="ca-sub two">View Candidate List</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="feedbackdata.php">
											...
											<div class="ca-content">
												...
												<h3 class="ca-sub three">View feedback List</h3>
											</div>
										</a>
									</li>
										<li>
										<a href="changepass.php">
											...
											<div class="ca-content">
												...
												<h3 class="ca-sub four">Change Password</h3>
											</div>
										</a>
									</li>
									<div class="clearfix"></div>
