...
{
	$ret=mysqli_query($db,"SELECT * FROM `adminlogin` WHERE Email='".$_POST['eml']."' and Password='".$_POST['pas']."'");
...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo admin"><h1><a href="index.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Admin Panel </a></h1></li>
		...
		<input type="email" name="eml" value="Username" required="">
	<input type="password" name="pas" value="Password" required="">
						<div class="tp">
