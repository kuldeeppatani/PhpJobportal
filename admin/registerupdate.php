...
if(isset($_POST['save']))
{
	...
	mysqli_query($datab,"UPDATE `registration` SET `Name`='$name',`Email`='$email' where id='".$_GET['userid']."'");
	mysqli_query($datab,"update `registration` set status='Approved' where id='".$_GET['userid']."' ");
}
...
<div class="panel panel-primary">
	<div class="panel-heading"><center><h2>Status Update</h2></center></div>
	<div class="panel-body">
			<?php
$user = mysqli_query($datab,"select * from `registration` where id='".$_GET['userid']."'");
while($row=mysqli_fetch_array($user))
{
	?>
		...
		<button class="btn btn-info btn-lg" name="save" type="submit">Update Status</button>
		</form>
	<?php } ?>
	</div>
</div>
