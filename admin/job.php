...
<li class="mini_list_w3"><a href="jobdatashow.php"> <i class="fa fa-caret-right" aria-hidden="true"></i>View Vacancy List</a></li>	
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle text-center">Add Vacancy</h2>
			...
			<form action="jobdata.php" method="post"> 
			 ...
			 <label>Job Title</label> 
				<input type="text" class="form-control"placeholder="Enter Job Title" name="job" required=""> </div></div>
				 <div class="form-group"> 
				 	<div class="col-md-6">
				 	<label>Post</label> 
	...
	<input type="text" class="form-control"placeholder="Enter Technology" name="techno" required="">
	 </div> </div>
	  <div class="form-group"> 
				 	<div class="col-md-6">
	...
	<input type="text" class="form-control"placeholder="Enter Comapny Name" name="cname" required="">
	 </div> </div>
	  <div class="form-group"> 
				 	<div class="col-md-6">
				 	<label>Salary Package Aprox 10,000 - 20,000</label> 
	<input type="text" class="form-control"placeholder="Enter Salary Package" name="salary" required="">
	 </div> </div>
	  <div class="form-group"> 
				 	<div class="col-md-12">
				 	<label>Address</label> 
	<input type="text" class="form-control"placeholder="Enter Address" name="add"required="">
	 ...
	 <button class="btn btn-primary btn-sm" name="save">Submit</button>
	  </form> 
			</div>
